...
/**
 * Created by louisgeek on 2018/7/1.
 * 1、进入设置 -> 扫描设置 -> Internal Scanner -> Default Profile -> Data Processing Settings -> Data Intent，
 * 勾选Data Intent，设置Action为"com.honeywell.testbroadcast"。
 * Honeywell EDA51-1
 */
public class Honeywell_EDA51_Impl implements IBarCode {
    private static final String TAG = "Honeywell_EDA51_Impl";

    private static final String INTENT_ACTION_SCAN_RESULT = "com.honeywell.testbroadcast";
    private static final String EXTRA_BARCODE_STRING = "data";
    ...
    public void start(Context context) throws Exception {
        ...
        if (context == null) {
            Log.e(TAG, "context is null in Honeywell_EDA51_Impl's start");
            return;
        }
