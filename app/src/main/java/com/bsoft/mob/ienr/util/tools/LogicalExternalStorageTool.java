...
public class LogicalExternalStorageTool {
    ...
    public static String getExternalStorageTotalSpaceFixed(Context context) {
        float mb = getExternalStorageTotalSpace(context) * 1.0f / 1024 / 1024 / 1024;
        return String.format(Locale.CHINA, "%.2f", mb);
    }
    public static long getExternalStorageTotalSpace(Context context) {
        String path = getPhysicalExternalStoragePath(context);
        if (EmptyTool.isBlank(path)) {
            return 0;
        }
    ...
    public static String getExternalStorageAvailableSpaceFixed(Context context) {
        float mb = getExternalStorageAvailableSpace(context) * 1.0f / 1024 / 1024 / 1024;
        return String.format(Locale.CHINA, "%.2f", mb);
    }
