...
import com.bsoft.mob.ienr.view.menus.CustomViewAbove.OnPageChangeListener;
...
public class SlidingMenu extends RelativeLayout {
	...
	/**
	 * Sets the img_shadow drawable.
	 *
	 * @param resId the resource ID of the new img_shadow drawable
	 */
	 ...
	 * Sets the img_shadow drawable.
	 *
	 * @param d the new img_shadow drawable
	 */
	...
	/**
	 * Sets the secondary (right) img_shadow drawable.
	 *
	 * @param resId the resource ID of the new img_shadow drawable
	 */
	...
	/**
	 * Sets the img_shadow width.
	 *
	 * @param resId The dimension resource id to be set as the img_shadow width.
	 */
	 ...
	 * Sets the img_shadow width.
	 *
	 * @param pixels the new img_shadow width, in pixels
	 */
