package com.bsoft.mob.ienr.barcode.ext;

import android.content.Context;
import android.content.Intent;

@Deprecated
public class IData80ScannerInterface {
	/********************************************扫描接口定义常量******************************/
	//打开与关闭扫描头
	...
	private static IData80ScannerInterface androidjni;

	public IData80ScannerInterface(Context context) {
		mContext = context;
