 ...
 * @author hy
 */
public class NurseEvaluateFormListActivity extends BaseBarcodeActivity {
    ...
    protected int setupLayoutResId() {
        return R.layout.activity_nurse_evaluate_form_list;
    }
    ...
    private OnItemClickListener onItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (item != null) {
                ...
                data.putExtra("isZKNotCheckBQ", item.isZKNotCheckBQ);
    ...
    class GetFormTask extends AsyncTask<Integer, String, Response<List<EvaluateRecordItem>>> {
        ...
        @Override
        protected Response<List<EvaluateRecordItem>> doInBackground(Integer... params) {
            ...
            if (type == TYPE_RECORD_FORM) {
                ...
                Response<List<EvaluateRecordItem>> response = api.GetNewEvaluationList(bqdm, jgid,mAppApplication.sickPersonVo.ZYH,
                        Constant.sysType);
                return response;
            }
            return null;
        ...
        protected void onPostExecute(Response<List<EvaluateRecordItem>> result) {
            ...
            if (result.ReType == 100) {
                new AgainLoginUtil(NurseEvaluateFormListActivity.this, mAppApplication, new AgainLoginUtil.LoginSucessListener() {
                    @Override
