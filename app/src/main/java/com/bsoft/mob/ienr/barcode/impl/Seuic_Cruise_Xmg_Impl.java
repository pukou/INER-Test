 ...
 *
 */
public class Seuic_Cruise_Xmg_Impl implements IBarCode {
	...
	public void start(Context context) throws Exception {
		...
		if (context == null) {
			Log.e(Constant.TAG, "context is null in Seuic_Cruise_Xmg_Impl's start");
			return;
		}
		// 监听
		mReceiver = new SeuicScanReceiver();
		IntentFilter filter = new IntentFilter();
		filter.addAction(SeuicActions.ACTION_RECEIVER_DATE_XMG);
	...
	public class SeuicScanReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (SeuicActions.ACTION_RECEIVER_DATE_XMG.equals(intent.getAction())) {
				String data = intent
